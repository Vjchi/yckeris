...
class PredictionTitle extends ValueObject<String> {
  ...
  factory PredictionTitle.fromString(String input) =>
      PredictionTitle._(right(input));
}
...
class PredictionDescription extends ValueObject<String> {
  ...
  factory PredictionDescription.fromString(String input) =>
      PredictionDescription._(
        right(input),
      );
}
